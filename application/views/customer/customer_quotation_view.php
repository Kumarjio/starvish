                  ...
                  <?php foreach($customer as $cust){} ?>
                    ...
                    <?php echo '<table class="table table-striped table-condensed table-hover table-bordered" style="border:3px solid black;font-family:Roboto;font-size:15px">
                      <tbody>
                        ...
                        <tr><td colspan="5"></td><td align="center" style="font-weight:bold">Yours faithfully</td></tr>
                        <tr><td colspan="5"></td><td align="center" style="font-style:italic;font-weight:bold">'.$cust->contact_person1.'</td></tr>
