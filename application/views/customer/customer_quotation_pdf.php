                      ...
                      <tbody>';
                       #Quotation
                          echo '<tr style="border-bottom:hidden">
                                ...
                                <tr style="border-bottom:hidden;">
                                  <td colspan="4" style="font-weight:bold">'.$cust->address2.'</td>
                                  <td align="right" style="font-weight:bold">Company\'s GSTN:</td><td style="font-weight:bold">'.$cmp->gstn.'</td>
                                </tr>

                                <tr style="border-bottom:hidden;">
                                  <td colspan="6" style="font-weight:bold">Contact no:'.$cust->contact_no1.','.$cust->contact_no2.'</td>
                                </tr>

                                <tr style="border-bottom:hidden;">
                                  <td colspan="6" style="border-bottom:double;font-weight:bold">'.$cust->email1.'</td>
                                </tr>';
                        ...
                        echo '<tr style="border-bottom:hidden"><td colspan="6">Dear Sir,</td></tr>
                              ...
                              <tr>
                                <td colspan="4" style="border:1px solid black;">Tax Value</td>
                                <td align="right" style="border:1px solid black;">Total Tax Value</td>
                                <td style="border:1px solid black;">4860</td>
                              </tr>

                              <tr>
                                <td colspan="4" style="border:1px solid black;font-weight:bold">Sl.no 1,2,3: IGST @ 18% = Rs.4860</td>
                                <td align="right" style="border:1px solid black;">Grand Total</td>
                                <td style="border:1px solid black;"></td>
                              </tr>

                              <tr><td colspan="6" style="border:1px solid black;border-bottom: double;">Amount in words: </td></tr>
                              <tr style="border-bottom:hidden"><td colspan="6">&nbsp;</td></tr>';
