              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title"> view customer #<?php echo $datas[0]->customer_id;?></h3>
                    </div><!-- /.box-header -->
                        ...
                        <div class="box-body">
                          ...
                          <table class="table table-striped table-condensed table-bordered">
                              <thead class="bg-primary">
                                <tr>
                                <th>Customer ID</th>
                                <td ><?php echo $datas[0]->customer_id;?></td>
                                </tr>
                              </thead>
                              <tbody class="bg-info">
                                <tr>
                          ...
                          foreach($files as $file)
                          {
                            echo '<tr>
                            <th>Attachment - '.$i++.'</th>
                            <td><a href="../uploads/customer/'.$file->file_name.'" target="_blank">'.$file->file_name.'</a></td>
                            </tr>';
                          }
                        }
                        else
                      ...
                      echo'    <tr>
                        ...
                        ?>
                          ...
                          <div class="box-footer">
                              <a class="btn btn-primary" href="<?php echo base_url(); ?>customer_master"><i class="fa fa-angle-left"></i> Back</a>
                              <a class="btn btn-success" href="<?php echo base_url().'add_edit_customer/'.$datas[0]->customer_id; ?>" title="Edit"><i class="fa fa-pencil"></i>Edit</a>&nbsp;
                          </div>
                      </form>
