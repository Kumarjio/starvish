				    ...
				    <?php echo form_open_multipart('add_vendor');?>
                        <div class="box-body">
                                          ...
                                          <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required digits" id="bank_acc_no" value="<?php echo set_value('bank_acc_no'); ?>" name="bank_acc_no" maxlength="20">
                                                </div>
                                            </div>
                          ...
                          <div class="box-footer">
                              <input type="submit" name="fileSubmit" class="btn btn-primary" value="Add Vendor" />
